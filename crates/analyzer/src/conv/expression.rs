...
mod tests {
    ...
    fn unary() {
        ...
        assert_eq!(x0.to_string(), "(+ 32'sh00000001)");
        assert_eq!(x1.to_string(), "(- 32'sh00000001)");
        assert_eq!(x2.to_string(), "(! 32'sh00000001)");
        assert_eq!(x3.to_string(), "(~ 32'sh00000001)");
        assert_eq!(x4.to_string(), "(& 32'sh00000001)");
        assert_eq!(x5.to_string(), "(| 32'sh00000001)");
        assert_eq!(x6.to_string(), "(^ 32'sh00000001)");
        assert_eq!(x7.to_string(), "(~& 32'sh00000001)");
        assert_eq!(x8.to_string(), "(~| 32'sh00000001)");
        assert_eq!(x9.to_string(), "(~^ 32'sh00000001)");
    }
    ...
    fn binary() {
        ...
        assert_eq!(x00.to_string(), "(32'sh00000001 ** 32'sh00000001)");
        assert_eq!(x01.to_string(), "(32'sh00000001 * 32'sh00000001)");
        assert_eq!(x02.to_string(), "(32'sh00000001 / 32'sh00000001)");
        assert_eq!(x03.to_string(), "(32'sh00000001 % 32'sh00000001)");
        assert_eq!(x04.to_string(), "(32'sh00000001 + 32'sh00000001)");
        assert_eq!(
            x05.to_string(),
            "(32'sh00000001 + (- 32'sh00000001))"
        );
        assert_eq!(x06.to_string(), "(32'sh00000001 << 32'sh00000001)");
        assert_eq!(x07.to_string(), "(32'sh00000001 >> 32'sh00000001)");
        assert_eq!(x08.to_string(), "(32'sh00000001 <<< 32'sh00000001)");
        assert_eq!(x09.to_string(), "(32'sh00000001 >>> 32'sh00000001)");
        assert_eq!(x10.to_string(), "(32'sh00000001 <: 32'sh00000001)");
        assert_eq!(x11.to_string(), "(32'sh00000001 <= 32'sh00000001)");
        assert_eq!(x12.to_string(), "(32'sh00000001 >: 32'sh00000001)");
        assert_eq!(x13.to_string(), "(32'sh00000001 >= 32'sh00000001)");
        assert_eq!(x14.to_string(), "(32'sh00000001 == 32'sh00000001)");
        assert_eq!(x15.to_string(), "(32'sh00000001 != 32'sh00000001)");
        assert_eq!(x16.to_string(), "(32'sh00000001 ==? 32'sh00000001)");
        assert_eq!(x17.to_string(), "(32'sh00000001 !=? 32'sh00000001)");
        assert_eq!(x18.to_string(), "(32'sh00000001 & 32'sh00000001)");
        assert_eq!(x19.to_string(), "(32'sh00000001 ^ 32'sh00000001)");
        assert_eq!(x20.to_string(), "(32'sh00000001 ~^ 32'sh00000001)");
        assert_eq!(x21.to_string(), "(32'sh00000001 | 32'sh00000001)");
        assert_eq!(x22.to_string(), "(32'sh00000001 && 32'sh00000001)");
        assert_eq!(x23.to_string(), "(32'sh00000001 || 32'sh00000001)");
        assert_eq!(
            x24.to_string(),
    ...
    fn boolean() {
        ...
        assert_eq!(x0.to_string(), "1'h1");
        assert_eq!(x1.to_string(), "1'h0");
    }
